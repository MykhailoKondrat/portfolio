...
export const Links: React.FC = () => (
	<div className="animate-fadeIn opacity-0 animation-delay-900 flex items-center gap-4 text-foreground mt-4 h-12 max-lg:flex-col max-lg:justify-center max-lg:align-center max-lg:mt-12">
